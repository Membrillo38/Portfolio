...
function Hero() {
  ...
  return (
    <>
      ...
      >
        <motion.h1
          className="text-8xl font-black flex items-center justify-center h-[90%] text-white flex-wrap"
        ...
        >
          ...
          <motion.div
            className="px-3 cormorant relative inline-block  text-pink-500"
            initial={{ width: 0 }}
          ...
          >
            <AnimatePresence mode="wait">
              <motion.span
                ...
                layout
                style={{ transformOrigin: 'center', lineHeight: '2rem' }}
              >
                {words[current]}
              </motion.span>
            </AnimatePresence>
