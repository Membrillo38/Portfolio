      ...
      <div className="">
        <AnimatePresence mode="popLayout">
          <motion.span
            ...
            className="helveticaL text-7xl lg:text-9xl font-bold"
            style={{
  ...
  return (
    <div className='w-full bg-black min-h-screen' id='myplan'>
     <div className='min-h-screen  flex flex-col items-center justify-center w-full '>
       <div className="text-white h-screen lg:h-fit w-full flex flex-col lg:flex-row items-center justify-center">
