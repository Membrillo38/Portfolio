      ...
      <div className='flex flex-col items-start group justify-between lg:p-12 p-2 py-4'>
       <div className='flex items-center justify-center'>
        ...
        <div className='flex mt-2 flex-col items-end justify-end'>
          ...
          <p
            className='hover:helveticaL mt-2 transition-all opacity-40 group-hover:opacity-100 duration-300 text-white'
            style={{ letterSpacing: '-0.01em' }}
          >
    ...
    IconsProjects.map((item, index) => (
      ...
      <div key={index} className='flex items-start justify-start flex-col px-4 py-8'>
        <div className='flex  items-center w-full justify-start'>
          <div className='max-w-10 max-h-10 min-w-10 min-h-10 rounded-full bg-black border-white border flex items-center justify-center'>
            {item.icon}
          </div>
          <div className='ml-4'>
        ...
        <div className='mt-4 flex'>
          <h3 className='text-4xl font-bold helveticaNB text-white'>
            {item.project}
          </h3>
        </div>
        {
